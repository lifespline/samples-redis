...
Read through the `system components docs <https://lifespline.github.io/agile/src/development_flow/architecture_analysis.html>`_ for an introduction on how to iteratively contribute to the **system components** of this project.
