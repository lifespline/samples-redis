#!/bin/bash
# The sample.sh script creates sample data that will be
# used in this section. To execute sample.sh, you need to have the
# Redis server and the Node.js application running. With the Redis
# server and Node.js running, execute the sample.sh script:
echo -e "Adding cars\n---------"
